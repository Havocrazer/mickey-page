...
const RepoSection = () => {
  return (
    <div className="bg-black bg-opacity-50 flex flex-wrap w-full h-full px-[70px] py-[60px] mt-[80px] justify-between">
      <div className="m-[50px] flex flex-col gap-[15px] cursor-pointer w-fit h-full p-[20px] hover:bg-gray-200 hover:bg-opacity-50 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:rounded-xl duration-300">
        <Link href="https://github.com/Havocrazer/NeatlyHotel" target="_blank">
          <Image
            src={neatly}
            alt=""
            className="w-[450px] h-[280px] rounded-xl mb-[20px]"
          />
          <p className="text-white text-[30px]">Neatly Hotel</p>
          <p className="w-[450px] text-white mb-[20px]">
            Create a hotel website that can search for rooms, book rooms, and
            manage rooms. The website has customer users and hotel admin users.
            Develop as a team Project
          </p>
          <p className="w-[450px] text-white">
            (tailwind CSS, daisy UI, material UI, Node.js, React, Axios, Prisma,
            Firebase Authentication, Express, PostgreSQL)
          </p>
        </Link>
      </div>
      <div className="m-[50px] flex flex-col gap-[5px] cursor-pointer w-fit h-full p-[20px] hover:bg-gray-200 hover:bg-opacity-50 hover:rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
        ...
        >
          <Image
            ...
            className="w-[450px] h-[280px] rounded-xl mb-[20px]"
          />
          <p className="text-white text-[30px]">Tourist Attraction</p>
          <p className="w-[450px] text-white mb-[20px]">
            Create a website that can search for tourist attractions. Develop as
      ...
      <div className="m-[50px] flex flex-col gap-[5px] cursor-pointer w-fit h-full p-[20px] hover:bg-gray-200 hover:bg-opacity-50 hover:rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
        ...
        >
          <Image
            ...
            className="w-[450px] h-[280px] rounded-xl mb-[20px]"
          />
          <p className="text-white text-[30px]">E-Commerce Product Page</p>
          <p className="w-[450px] text-white mb-[20px]">
      ...
      <div className="m-[50px] flex flex-col gap-[5px] cursor-pointer w-fit h-full p-[20px] hover:bg-gray-200 hover:bg-opacity-50 hover:rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
        ...
        >
          <Image
            ...
            className="w-[450px] h-[280px] rounded-xl mb-[20px]"
          />
          <p className="text-white text-[30px]">Tip Calculator</p>
          <p className="w-[450px] text-white mb-[20px]">
          ...
          <p className="w-[450px] text-white">(HTML, CSS, react.js, Node.js)</p>
        </Link>
      </div>
      <div className="m-[50px] flex flex-col gap-[5px] cursor-pointer w-fit h-full p-[20px] hover:bg-gray-200 hover:bg-opacity-50 hover:rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
        <Link
        ...
        >
          <Image
            ...
            className="w-[450px] h-[280px] rounded-xl mb-[20px]"
          />
          <p className="text-white text-[30px]">BMI Calculator</p>
          <p className="w-[450px] text-white mb-[20px]">
            Create a BMI calculator app that you can type your weight and your
            height and the app will automatically calculate your BMI and display
            the result to you. Develop as an individual Project
          </p>
          <p className="w-[450px] text-white">(HTML, CSS, Next.js, Node.js)</p>
        </Link>
      </div>
    </div>
  );
